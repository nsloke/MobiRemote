...
public class EventzActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edtc=(EditText)findViewById(R.id.edtdt);
        btnx=(Button) findViewById(R.id.btnsvevt);
        ...
        btnx.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent(EventzActivity.this, MainActivity.class);
                startActivity(i);
